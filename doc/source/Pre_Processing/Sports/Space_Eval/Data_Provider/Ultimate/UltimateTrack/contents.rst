UlatimateTrack
============================================
.. class:: Space_data(data_provider='UltimateTrack', tracking_data_path=tracking_data_path, out_path=None, testing_mode=False).preprocessing() -> pd.DataFrame

    Load the UltimateTrack tracking from csv files(s) and convert it into a DataFrame.
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        tracking_path = './UltimateTrack/Tracking Data'
        out_path = './'

        Space_data(data_provider='UltimateTrack',
